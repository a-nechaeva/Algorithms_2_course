...
\fancypagestyle{style}{ % создание нового стиля style
	...
	\fancyhead[RO, LE]{Задачи 1005 и 1155} % название section наверху
...
\newpage
\section{Цель}
Разработать и реализовать алгоритмы для решения задач 1005 и 1155.
...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{pic/screen_1005.png}}
...
\begin{figure}[h]
\center{\includegraphics[width=0.94\linewidth]{pic/task_1155.png}}
